    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center ">
                ...
                <a href="{{ route('titles.create') }}" class="btn btn-primary text-white" title="Nuevo">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{ route('titles.edit',['title'=>$title]) }}">
                                        <i class="fas fa-pen-alt"></i> Editar
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <form action="{{route('titles.destroy',['title'=>$title])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
