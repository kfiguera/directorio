        ...
        switch ($this->method()) {
            case 'POST':
            {
                return [
                    ...
                    "extension" => ["numeric","min:4","nullable",'required_if:phone,null','unique:directories,extension'],
                    "title_id" => "required",
                    "office_id" => "required",
                    "state_id" => "required"
                ];
            ...
            case 'PUT':
            {
                return [
                    ...
                    "extension" => ["numeric","min:4","nullable",'required_if:phone,null','unique:directories,extension,'.$this->route('directory')->id],
                    "title_id" => "required",
                    "office_id" => "required",
                    "state_id" => "required"
                ];
